...
function loadUndoneReminders(){
    ...
    axios.get("http://localhost:8080/api/reminders/getUndone")
        .then((response) => {
...
function loadDoneReminders(){
    ...
    axios.get("http://localhost:8080/api/reminders/getDone")
        .then((response) => {
...
function createReminder(){
    ...
    axios.post("http://localhost:8080/api/reminders/create", {title: reminder, expiration: date})
        .then((response) => {
...
function makeDone(element) {
    ...
    axios.post("http://localhost:8080/api/reminders/makeDone", {reminder_id: element.id})
        .then((response) => {
            if(response.status === 200){
...
function makeUndone(element) {
    ...
    axios.post("http://localhost:8080/api/reminders/makeUndone", {reminder_id: element.id})
        .then((response) => {
            if(response.status === 200){
